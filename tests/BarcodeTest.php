...
class BarcodeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function png_barcode_generator_can_generate_code_128_barcode()
    {
        ...
        $generated = $generator->getBarcode('081231723897', 'CODE_128');
    ...
    public function svg_barcode_generator_can_generate_ean_13_barcode()
    {
        ...
        $generated = $generator->getBarcode('081231723897', 'EAN_13');
    ...
    public function jpg_barcode_generator_can_generate_code_128_barcode()
    {
        ...
        $generator->getBarcode('081231723897', 'CODE_128');
    }
    ...
    {
        $generator = new Picqer\Barcode\BarcodeGeneratorSVG();
        $generator->getBarcode('A123', 'EAN_13');
    }
    ...
    {
        $generator = new Picqer\Barcode\BarcodeGeneratorSVG();
        $generated = $generator->getBarcode('0049000004632', 'EAN_13');
    ...
    {
        $generator = new Picqer\Barcode\BarcodeGeneratorSVG();
        $generated = $generator->getBarcode('004900000463', 'EAN_13');
    ...
    {
        $generator = new Picqer\Barcode\BarcodeGeneratorSVG();
        $generated = $generator->getBarcode('04900000463', 'EAN_13');
    ...
    {
        $generator = new Picqer\Barcode\BarcodeGeneratorSVG();
        $generator->getBarcode('0049000004633', 'EAN_13');
    }
